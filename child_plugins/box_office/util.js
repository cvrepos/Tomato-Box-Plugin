...
function pickTomatoes(info, tab){
...
//setup contxt menu item
var contexts = ["selection", "link", "editable"];

// Create a parent item and two children.
var parent = chrome.contextMenus.create({"title": "Box Office->", "contexts":contexts});
var child1 = chrome.contextMenus.create(
          {"title": "Recommend it!", "parentId": parent, "contexts":contexts, "onclick": pickTomatoes});
var child2 = chrome.contextMenus.create(
          {"title": "Ask your circle.", "parentId": parent,"contexts":contexts,  "onclick": pickTomatoes});
...
chrome.browserAction.onClicked.addListener(function() {
     ...
     chrome.tabs.getCurrent( function(tab) {
                  chrome.tabs.executeScript(tab.id, {file: "parser.js"}, function() {
